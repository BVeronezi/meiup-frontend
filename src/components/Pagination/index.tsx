...
export function Pagination({ 
    ...
    const lastPage = totalCountOfRegisters / registerPerPage;
    ...
    const nextPages = currentPage < lastPage
        ? generatePagesArray(currentPage, Math.min(currentPage + sliblingsCount, lastPage))
        : []
    ...
    return(
        ...
        >
            <Box>
                <strong>{currentPage}</strong> - <strong>10</strong> de <strong>{totalCountOfRegisters}</strong>
            </Box>
